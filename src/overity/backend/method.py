...
def list_preparation_methods(program_path: Path | str):
    """List the current available preparation methods from the given program path"""
    ...
    methods, errors = st.preparation_methods()
